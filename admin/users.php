         ...
         foreach ($result as $fetch_users) {
            ...
            if($is_sortedBy == 'department' || $is_sortedBy == 'specialty' || $is_sortedBy == 'level'){
               ...
               if($seperate_depart != ''){
                  ...
                  // echo "<tr><td colspan='13'><h3 style='text-transform: capitalize;'>". $and . ": " .$fetch_users[$and] ."</h3></td></tr>";
               ...
               if($seperate_depart1 != '' || $seperate_depart2 != ''){
                  ...
                  echo "<tr><td colspan='13'><h3 style='text-transform: capitalize;'>". $is_sortedBy1 . ": " .$cur1 ."</h3></td></tr>";
                  echo "<tr><td colspan='13'><h3 style='text-transform: capitalize;'>". $is_sortedBy2 . ": " .$cur2 ."</h3></td></tr>";
               }
